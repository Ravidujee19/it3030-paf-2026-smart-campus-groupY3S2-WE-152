...
public class BookingService {
    ...
    public BookingDto reviewBooking(Long bookingId, Booking.BookingStatus newStatus, String reason) {
        ...
        // Send notification
        String title = newStatus == Booking.BookingStatus.APPROVED ? "Booking Approved" : "Booking Rejected";
        String message = String.format("Your booking for %s has been %s. %s",
                booking.getResource().getName(),
                newStatus.name().toLowerCase(),
                newStatus == Booking.BookingStatus.REJECTED ? "Reason: " + reason : "");
        
        notificationService.createNotification(
                booking.getUser().getEmail(),
                title,
                message,
                newStatus == Booking.BookingStatus.APPROVED ? NotificationType.SUCCESS : NotificationType.ERROR
        );
    ...
    public BookingDto cancelBooking(Long bookingId, Long userId, boolean isAdmin) {
        ...
        notificationService.createNotification(
                booking.getUser().getEmail(),
                "Booking Cancelled",
                String.format("The booking for %s has been cancelled.", booking.getResource().getName()),
